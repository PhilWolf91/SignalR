...
var initiateSignalR = function(){
 ...
 $.connection.hub.logging = true
    ...
    // $.getScript("http://wolf-signalrserver.azurwebsites.net/signalr/hubs", function(){
    //     alert("Loaded HUBS successfully and beggining connection");
    //     $.connection.hub.logging = true
    //     $.connection.hub.qs = { 'username': username }
    //     $.connection.hub.url = appConfig.serverUrl + "/signalr";
    //     var chatHub = $.connection.chatHub
    ...
    // }).fail(function(){
    //     alert("failed to load your HUBS script");
    // })
